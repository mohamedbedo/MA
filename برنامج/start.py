...
🔖 **لمعرفة كيفية استخدام هذا الروبوت ، الرجاء النقرال فوق » ❓ زر الدليل الاساسي!**
""",
            ...
            [
                [
                    InlineKeyboardButton(
                        ...
                        url=f"https://t.me/{NUTELLA1_BOT}?startgroup=true",
                    )
                ],
                [InlineKeyboardButton("📄︙شروحـات البـوت", callback_data="cbhowtouse")],
                [
                    InlineKeyboardButton("🐼︙الـأوامــر", callback_data="cbcmds"),
                    InlineKeyboardButton("🎸︙الــــمطور", url=f"https://t.me/{MA_RLOW}"),
                ],
                [
                    InlineKeyboardButton(
                        "◜𝑚𝑦 𝑑𝑒𝑣◞", url=f"https://t.me/MA_RLOW"
                    ),
                    InlineKeyboardButton(
                        "◜𝘴ꪮꪊ𝘳ᥴꫀ◞", url=f"https://t.me/MARLOW5_5"
                    ),
                ],
                [
                    InlineKeyboardButton(
                        "صانع بوتات حماية", url="https://t.me/"
                    )
                ],
            ]
        ),
...
async def alive(client: Client, message: Message):
    ...
    keyboard = InlineKeyboardMarkup(
        [
            [
                InlineKeyboardButton("◜𝘴ꪮꪊ𝘳ᥴꫀ◞", url=f"https://t.me/MARLOW5_5"),
                InlineKeyboardButton(
                    "◜𝑚𝑦 𝑑𝑒𝑣◞", url=f"https://t.me/MA_RLOW"
                    "◜𝑚𝑦 𝑑𝑒𝑣◞", url=f"https://t.me/Hk_MB"
                ),
            ]
        ]
    )
...
@Client.on_message(command(["uptime", f"uptime@{NUTELLA1_BOT}", "بوت", "الوقت"]) & ~filters.edited)
        ...
        if member.id == bot_id:
            return await m.reply(
                ...
                "**قـم بتـرقيتـي مشرف عـن المـجـموعـة ، وإلا فلـن أتمـكن مـن الـعـمل بـشـكل صـحيـح ، ولا تنـسـى الـكتابـة /userbotjoin لـدعـوة المـساعـد.**\n\n"
                 الانـتهـاء ، اكـتـب**"/restart",
                reply_markup=InlineKeyboardMarkup(
                    [
                        [
                            InlineKeyboardButton("◜𝘴ꪮꪊ𝘳ᥴꫀ◞", url=f"https://t.me/MARLOW5_5"),
                            InlineKeyboardButton("◜𝑚𝑦 𝑑𝑒𝑣◞", url=f"https://t.me/MA_RLOW"),
                            InlineKeyboardButton("◜𝑚𝑦 𝑑𝑒𝑣◞", url=f"https://t.me/Hk_MB"),
                        [, 
