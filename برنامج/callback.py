...
💡 **اكتشف جميع أوامر البوت وكيفية عملها من القر فوق » 📚 زر الاوامر!**

🔖 **لمعرفة كيفية استخدام هذا البوت ، الرجاء النقر فوق » ❓ زر الدليل الاساسي!**""",
        reply_markup=InlineKeyboardMarkup(
            [
                ...
                [
                    InlineKeyboardButton(
                        "◜𝑚𝑦 𝑑𝑒𝑣◞", url=f"https://t.me/M_A_RLO_W"
                    ),
                    InlineKeyboardButton(
                        "◜𝘴ꪮꪊ𝘳ᥴꫀ◞", url=f"https://t.me/MALOW_WW"
                    ),
                ],
                [
                    InlineKeyboardButton(
                        "صانع بوتات حمايه", url="https://t.me/"
                    )
                ],
            ]
        ),
...
⚡ __Powered by {BOT_NAME} A.I__""",
        reply_markup=InlineKeyboardMarkup(
            [[InlineKeyboardButton("🔙 ︙رجــــــوع", callback_data="cbstart")]]
        ),
    )
...
⚡️ __Powered by {BOT_NAME} AI__""",
        reply_markup=InlineKeyboardMarkup(
            [[InlineKeyboardButton("🔙 ︙رجــــــوع", callback_data="cbcmds")]]
        ),
    )
